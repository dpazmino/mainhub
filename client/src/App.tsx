...
import ResilienceReportPage from "@/pages/resilience-report";
import { AppShell } from "@/components/app-shell";
import { queryClient } from "./lib/queryClient";

function Shell({ children }: { children: React.ReactNode }) {
  const [location] = useLocation();
  const hideShell = location === "/" || location === "/tech-admin" || location === "/resilience-report";
  ...
  return (
    <Shell>
      <Switch>
        ...
        <Route path="/resilience-report" component={ResilienceReportPage} />
